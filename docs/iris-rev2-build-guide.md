...
![Iris Rev. 2 parts laid out](./assets/images/iris-rev2/JMq4iIA.jpg)
...
On the bottom side of the PCB, insert diodes with the black line towards the bottom. Square = Black line. All of the diodes are oriented vertically on the PCB:![First Diode Inserted in PCB](./assets/images/iris-rev2/Pft9ufA.jpg)
...
Bend the legs out to hold the diodes in place for when you solder them in:![Diode Legs Bent Out on PCB](./assets/images/iris-rev2/TaYV4vF.jpg)

Diode insertion complete:![Both PCBs with Diodes Inserted](./assets/images/iris-rev2/xoO48or.jpg)

Left PCB:![Left PCB with Diodes Inserted](./assets/images/iris-rev2/O4wuLju.jpg)

Right PCB:![Right PCB with Diodes Inserted](./assets/images/iris-rev2/ZD4B4PR.jpg)

### Solder reset push buttons and TRRS jacks

Add the TRRS jacks and reset switches:![TRRS Jack and Reset Switch Added](./assets/images/iris-rev2/dFTBf3h.jpg)
...
Add the 2 4.7kΩ resistors for I2C on only one half (I normally do this on the master/left half). Left half shown here:![I2C Resistors on Left PCB](./assets/images/iris-rev2/ncxMpI2.jpg)

### Solder LED support components \(optional\)

Add a 4.7kΩ resistor for LED support in the R3 slot:![LED Support Resistor on PCB](./assets/images/iris-rev2/Jvg2o4d.jpg)

Add 470Ω resistors for LEDs. Resistors don't have polarity, so orientation doesn't matter. **Note that the resistor that's seated with the Pro Micro has been inserted on the top side of the PCB, which prevents it from touching the Pro Micro.** (This resistor will be relocated out of the way in future versions of the PCB). Left side shown here:![LED Resistors on Left PCB](./assets/images/iris-rev2/SERhlBs.jpg)

Right PCB:![LED Resistors on Right PCB](./assets/images/iris-rev2/3CJVPlx.jpg)
...
To add the MOSFET, tin one of the pins on the PCB first:![Tinning MOSFET Pad on PCB](./assets/images/iris-rev2/nsehRiB.jpg)

Hold the MOSFET with a pair of tweezers and align it over the footprint. Then solder the first pin:
![MOSFET held with tweezers, soldering first pin](./assets/images/iris-rev2/tNMOzPH.jpg)

Once you're satisfied with the alignment, solder the other 2 pins:![MOSFET Soldered on PCB](./assets/images/iris-rev2/Zm2iJfF.jpg)

Repeat the MOSFET installation process on the other PCB:![MOSFET on Right PCB](./assets/images/iris-rev2/e4EfGla.jpg)

### Solder Pro Micro header pins

Install the header pins for the Pro Micro on the underside of the PCB (left PCB shown). You can use some tape to hold the header pins in place while soldering. Solder one pin on and re-adjust/re-solder as needed before doing the rest of the row:![Tape Holding Header Pins in Place](./assets/images/iris-rev2/TdZ9a23.jpg)

Completed right PCB:![Right PCB Header Pins Complete](./assets/images/iris-rev2/ijqRWEo.jpg)

Left PCB shown:![Left PCB Header Pins Complete](./assets/images/iris-rev2/3WUkRM7.jpg)

## Add 2u stabilizers \(optional\)

Add the 2u stabilizer if desired. Do this before installing the switch plate and switches:![2u Stabilizers Installed on PCB](./assets/images/iris-rev2/m0mqljb.jpg)
...
Add switches into the switch plate. Usually, I add switches to the corners first and then solder them before installing the rest of them:![Corner Switches in Switch Plate](./assets/images/iris-rev2/deDoaSq.jpg)

All installed:![Both Halves Switches Installed](./assets/images/iris-rev2/tztl5XA.jpg)

## Solder LEDs

Install the LEDs. Longer leg is the anode and goes with the circular pad marked with \+. The shorter leg is the cathode and goes with the square pad marked with \-:![LED Inserted in Switch](./assets/images/iris-rev2/A10RlbS.jpg)
...
Trim down the switch pins, LED pins, and resistor pins that the Pro Micro will sit on top of with a flush cutter:![Flush Cutters Trimming Switch Pins](./assets/images/iris-rev2/vh0WAXg.jpg)

## Flash Pro Micros

![Pro Micro controllers with header pins](./assets/images/iris-rev2/Ca93q9s.jpg)
...
![Kapton tape applied over TRRS jack and Pro Micro area](./assets/images/iris-rev2/Qw7qrWA.jpg)
...
![Pro Micro placed on PCB header pins, left half](./assets/images/iris-rev2/IMDAm28.jpg)
...
Right half:![Pro Micro on Right Half PCB](./assets/images/iris-rev2/2KMFIE4.jpg)

Left PCB on the left, right PCB on the right:![Both PCBs with Pro Micros](./assets/images/iris-rev2/x950DTT.jpg)
