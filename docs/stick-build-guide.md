...
![The Stick Kit Parts Laid Out](./assets/images/stick/IMG_0438.jpg)
...
![Tin Added to One RGB LED Pad](./assets/images/stick/IMG_0445.jpg)
...
![RGB LED Placed in PCB Slot](./assets/images/stick/IMG_0446.jpg)
...
![PCB with All RGB LEDs Soldered](./assets/images/stick/IMG_0448.jpg)
...
![PCB with Six-Pin Header Pieces](./assets/images/stick/IMG_0470.jpg)
...
![Six-Pin Header Inserted Upside Down](./assets/images/stick/IMG_0471.jpg)
...
![Header Pins Soldered from Top Side](./assets/images/stick/IMG_0472.jpg)
...
![Tweezers Removing Header Pin Plastic](./assets/images/stick/IMG_0473.jpg)

You may want to insert a rolled up piece of paper in between the PCB and the tweezers to protect the PCB.

![Paper Protecting PCB During Plastic Removal](./assets/images/stick/IMG_0475.jpg)
...
![Two Header Pin Rows Inserted in PCB](./assets/images/stick/IMG_0449.jpg)

Flip the PCB and solder the pins.

![PCB with Header Pins Soldered](./assets/images/stick/IMG_0451.jpg)
...
![Switch Plate Encoder Cutout Gap Annotation](./assets/images/stick/encoder_gap.jpg)

Insert two switches into the switch plate as shown and solder them in.

![Two Switches Inserted in Switch Plate](./assets/images/stick/IMG_0452.jpg)
...
![Header Pins Sticking Through Switch Plate](./assets/images/stick/IMG_0453.jpg)

Add the two switches where the controller will end up.

![Switches Added near Controller Area](./assets/images/stick/IMG_0454.jpg)
...
![Wide Keycap Used to Align Switches](./assets/images/stick/IMG_0455.jpg)

Another way is to put keycaps on and wedge folded up piece of paper in between the keycaps.

![Keycaps and Paper Aligning Switches](./assets/images/stick/IMG_0456.jpg)
...
![Switches and Encoders Installed in Plate](./assets/images/stick/IMG_0458.jpg)
...
![PCB Underside with Encoder Pins Soldered](./assets/images/stick/IMG_0459.jpg)

## Solder controller

Place the controller onto the header pins.

![Pro Micro Placed on Header Pins](./assets/images/stick/IMG_0461.jpg)

Then, solder all of the header pins.

![Pro Micro with All Pins Soldered](./assets/images/stick/IMG_0462.jpg)

Clip the extra length of the header pins off.

![Flush Cutter Trimming Header Pin Legs](./assets/images/stick/IMG_0463.jpg)

Looking good, you're done with the soldering.

![Completed Pro Micro on PCB](./assets/images/stick/IMG_0464.jpg)
...
![Standoff Inserted Through Switch Plate](./assets/images/stick/IMG_0460.jpg)

Repeat the process for the other 5 holes. Then place the middle layer over the standoffs.

![Middle Layer Placed over Standoffs](./assets/images/stick/IMG_0466.jpg)

Put bottom plate on and add the 8mm screws.

![Bottom Plate Assembled with Screws](./assets/images/stick/IMG_0467.jpg)

Put on some keycaps and knobs. You're done!

![Completed Stick with Keycaps and Knobs](./assets/images/stick/IMG_0468.jpg)
