...
![BDN9 Rev. 1.3 Kit Parts](./assets/images/bdn9-rev1.3/IMG_9192.jpg)
...
![PCB with Resistors Soldered In](./assets/images/bdn9-rev1.3/IMG_9199.jpg)
...
![Resistor Leads Poking Through PCB](./assets/images/bdn9-rev1.3/IMG_9200.jpg)

![Resistor Leads Trimmed Flush](./assets/images/bdn9-rev1.3/IMG_9201.jpg)

### Solder the MOSFET \(optional\)

![Solder Added to MOSFET Pad](./assets/images/bdn9-rev1.3/IMG_9193.jpg)

Add a bit of solder to one leg of the MOSFET pad Q1.

![Tweezers Holding MOSFET on Pad](./assets/images/bdn9-rev1.3/IMG_9194.jpg)
...
![MOSFET Soldered Straight on PCB](./assets/images/bdn9-rev1.3/IMG_9195.jpg)

Now that the MOSFET is soldered on straight, solder the other two legs.

### Solder the reset button

![Solder Added to Reset Switch Pad](./assets/images/bdn9-rev1.3/IMG_9196.jpg)

Add a bit of solder to one pad of the reset switch location on the PCB.

![Reset Switch First Leg Soldered](./assets/images/bdn9-rev1.3/IMG_9197.jpg)

Add the reset button to the bottom side of the PCB and solder the first leg.

![Reset Switch Fully Soldered on PCB](./assets/images/bdn9-rev1.3/IMG_9198.jpg)

Once the first leg is aligned correctly, solder the other three legs of the reset switch.

### Solder Pro Micro header pins

![Header Pins Inserted in PCB](./assets/images/bdn9-rev1.3/IMG_9202.jpg)
...
![Header Pins Soldered to PCB](./assets/images/bdn9-rev1.3/IMG_9203.jpg)
...
![Three Rotary Encoders Inserted in PCB](./assets/images/bdn9-rev1.3/IMG_9234.jpg)

Insert the rotary encoders from the top-side of the PCB.

![Rotary Encoders Soldered on PCB](./assets/images/bdn9-rev1.3/IMG_9235.jpg)
...
![Switches in Switch Plate](./assets/images/bdn9-rev1.3/IMG_9204.jpg)

Add the switches to the switch plate.

![Switch Plate with Encoders and Switches](./assets/images/bdn9-rev1.3/IMG_9236.jpg)

Then, place it on top of the PCB and make sure all the switches are seated firmly into the PCB.

![Switch Plate Placed on PCB](./assets/images/bdn9-rev1.3/IMG_9237.jpg)

Solder the switches onto the PCB.

## Solder LEDs \(optional\)

![LED Legs Poking Through Switch Hole](./assets/images/bdn9-rev1.3/IMG_9238.jpg)
...
![LED Legs Bent Out on PCB](./assets/images/bdn9-rev1.3/IMG_9239.jpg)

Bend the legs of the LEDs outwards a bit to hold them in place.

![LEDs Soldered with Legs Clipped](./assets/images/bdn9-rev1.3/IMG_9240.jpg)
...
![Kapton Tape Applied over Switch Area](./assets/images/bdn9-rev1.3/IMG_9241.jpg)

Then put some electrical or Kapton tape on top of the area the Pro Micro will be.

![Pro Micro Placed over Header Pins](./assets/images/bdn9-rev1.3/IMG_9242.jpg)

Insert Pro Micro over the header pins.

![Pro Micro Corner Pins Soldered](./assets/images/bdn9-rev1.3/IMG_9243.jpg)

Add solder to two opposite corners of the Pro Micro and make sure the controller is aligned properly and is level.

![Pro Micro Fully Soldered on PCB](./assets/images/bdn9-rev1.3/IMG_9244.jpg)
...
![Solder Added to One RGB LED Pad](./assets/images/bdn9-rev1.3/IMG_9245.jpg)

Add solder to one pad of each LED footprint.

![Tweezers Placing RGB LED on Pad](./assets/images/bdn9-rev1.3/IMG_9292.jpg)
...
![RGB LEDs with Remaining Pads Soldered](./assets/images/bdn9-rev1.3/IMG_9294.jpg)

Once the LEDs are aligned properly, solder the other 3 pads. Make sure each pad of the LED has enough solder on it.

## Assemble Case

![Standoffs Screwed into Switch Plate](./assets/images/bdn9-rev1.3/IMG_9246.jpg)

Screw in the standoffs to the switch plate at all four corners.

![Bottom Plate Screwed onto Standoffs](./assets/images/bdn9-rev1.3/IMG_9295.jpg)

Add the bottom plate and screw it in.

![Completed BDN9 with Encoders and Switches](./assets/images/bdn9-rev1.3/IMG_9296.jpg)
